...
function TabsTrigger({
  ...
  return (
    <TouchableOpacity
      ...
      onPressOut={Platform.OS === 'android' ? () => setActiveTab(value) : undefined}
      onPress={Platform.OS === 'ios' ? () => setActiveTab(value) : undefined}
      {...props}
    >
      <Text
        className={cn(
          'font-manrope-medium text-center text-muted-foreground',
